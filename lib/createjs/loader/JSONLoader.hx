...
/**
 * A loader for JSON files. To load JSON cross-domain, use JSONP and the JSONPLoader instead.
 ...
 * 							Prior to version 0.6.0, this was just a regular Event.
 * 
 * Documentation: https://www.createjs.com/docs/preloadjs/classes/JSONLoader.html
 * @author VolkovRA
 */
...
extern class JSONLoader extends AbstractLoader 
{
	 ...
	 * This loader can only load items that are of type JSON.
