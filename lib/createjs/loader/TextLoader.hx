 ...
 * 							Prior to version 0.6.0, this was just a regular Event.
 * 
 * Documentation: https://www.createjs.com/docs/preloadjs/classes/TextLoader.html
 * @author VolkovRA
 */
...
extern class TextLoader extends AbstractLoader 
{
	 ...
	 * This loader loads items that are of type TEXT, but is also the default loader if a file type can not be determined.
