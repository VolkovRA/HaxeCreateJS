...
/**
 * HTMLAudioSoundInstance extends the base api of AbstractSoundInstance and is used by HTMLAudioPlugin.
 * 
 * EVENTS
 ...
 * 
 * Documentation: https://www.createjs.com/docs/soundjs/classes/HTMLAudioSoundInstance.html
 * @author VolkovRA
 */
...
{
	/**
	 * Create a new HTMLAudioSoundInstance.
	...
	/**
	 * Returns a string representation of this HTMLAudioSoundInstance.
